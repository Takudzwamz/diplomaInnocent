        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LimitOnePerCustomer = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingAddress_DeliveryNotes = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ItemOrdered_ProductVariantId = table.Column<int>(type: "int", nullable: true),
                    ...
                    ItemOrdered_SelectedOptions = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Price = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductProductOptions", x => new { x.OptionsId, x.ProductsId });
                    table.ForeignKey(
                        name: "FK_ProductProductOptions_ProductOptions_OptionsId",
                        column: x => x.OptionsId,
                        principalTable: "ProductOptions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductProductOptions_Products_ProductsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductVariants_ProductImage_ImageId",
                        column: x => x.ImageId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductVariantOptionValues", x => new { x.OptionValuesId, x.VariantsId });
                    table.ForeignKey(
                        name: "FK_ProductVariantOptionValues_ProductOptionValues_OptionValuesId",
                        column: x => x.OptionValuesId,
                        principalTable: "ProductOptionValues",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductVariantOptionValues_ProductVariants_VariantsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductProductOptions_ProductsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductVariantOptionValues_VariantsId",
